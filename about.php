...
<div class="container">
    <div class="card">
        ...
        <p style="margin-top:20px;">
            ...
            <a class="btn" href="citizen_feedback.php" style="background:var(--panel-2);color:var(--text);">💬 Feedback</a>
            <a class="btn" href="citizen_help.php" style="background:var(--panel-2);color:var(--text);">🆘 Gargaarsa</a>
        </p>
    </div>
</div>
</body>
